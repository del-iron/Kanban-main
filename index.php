...
<head>
    ...
    <link rel="stylesheet" href="assets/css/styles.css"> <!-- CSS principal do projeto -->
    <title>Login - ESP</title> <!-- Título da aba do navegador -->
</head>
<body>
    <section class="main-login"> <!-- Seção principal da tela de login -->
        <div class="login-content"> <!-- Container centralizado do formulário -->
            <form action="login.controller.php?action=login" method="post"> <!-- Formulário de login, envia para login.controller.php -->
                <p class="kanban-title">ESP - Login</p> <!-- Título estilizado do sistema -->
                ...
                <div class="container-p"> <!-- Container para o link de cadastro -->
                    <a href="register.php"><p>Cadastrar</p></a> <!-- Link para tela de cadastro -->
                </div>
            </form>
        </div>
    </section>
